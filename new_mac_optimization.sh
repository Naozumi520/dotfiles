#!/usr/bin/env bash
# sources: 
# https://github.com/D4NH/dotfiles/blob/master/new_mac_optimization.sh
# https://medium.com/@echohack/guide-to-make-your-mac-suck-less-2017-88a57563aac7#.mthwwk59i
